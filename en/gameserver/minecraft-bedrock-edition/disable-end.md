...
Unlike Java Edition, Bedrock servers have **no setting in `server.properties`** to disable the End. Instead, you have to block access to the dimension in a different way.
