...
# So erstellst du ein Backup deines Black Mesa Servers
...
Wenn du nur die wichtigsten Dateien sichern möchtest, lade dir per [SFTP](../sftp-verbindung-herstellen.md) die Ordner `/bms/cfg/`, `/bms/addons/` und `/bms/maps/` sowie die Datei `/bms/addonlist.txt` herunter.
::::
