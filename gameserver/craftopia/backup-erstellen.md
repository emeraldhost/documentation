...
# So erstellst du ein Backup deines Craftopia Servers
...
:::: info Hinweis
Möchtest du nur den Spielstand sichern, kannst du den Ordner `DedicatedServerSave` auch einzeln herunterladen: [Savegame herunterladen](savegame-herunterladen.md).
::::
