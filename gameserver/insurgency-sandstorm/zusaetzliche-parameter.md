...
# So setzt du zusätzliche Parameter auf deinem Insurgency: Sandstorm Server
...
|-----------|--------------|
| `-Mods` | Aktiviert das Mod-System (mod.io) — siehe [Mods aktivieren](mods-aktivieren.md) |
