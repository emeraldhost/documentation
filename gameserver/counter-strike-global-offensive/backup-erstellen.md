...
# So erstellst du ein Backup deines Counter-Strike Global Offensive Servers
...
Wenn du nur die wichtigsten Dateien sichern möchtest, lade dir per [SFTP](../sftp-verbindung-herstellen.md) die Ordner `/csgo/cfg/`, `/csgo/addons/` und `/csgo/maps/` herunter.
::::
