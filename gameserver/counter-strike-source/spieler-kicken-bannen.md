...
# So kickst und bannst du Spieler auf deinem Counter-Strike Source Server
...
:::: info Hinweis
Alternativ stoppst du deinen Server und löschst die betreffende Zeile per [SFTP](../sftp-verbindung-herstellen.md) aus `/cstrike/cfg/banned_user.cfg` beziehungsweise `/cstrike/cfg/banned_ip.cfg`.
::::
