...
# So erstellst du ein Backup deines No More Room in Hell Servers
...
Wenn du nur die wichtigsten Dateien sichern möchtest, lade dir per [SFTP](../sftp-verbindung-herstellen.md) die Ordner `/nmrih/cfg/`, `/nmrih/addons/` und `/nmrih/maps/` herunter.
::::
