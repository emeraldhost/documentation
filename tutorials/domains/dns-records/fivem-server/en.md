...
slug: "fivem-server"
language: "en"
title: "How to Connect Your Domain to a FiveM Server"
description: "Connect a domain to a FiveM server"
tags: []
date: "2026-04-07"
visibility: "public"
updated: "2026-04-09"
...
You can make your FiveM server reachable via your own domain, so players can connect using e.g. `play.yourdomain.com` or `yourdomain.com` – instead of an IP address.

## Requirements

- A domain with EmeraldHost
- The IP address and port of your FiveM server (you can find these in the **dashboard** of your server)
...
3. **Create SRV record**\
   Create a new record with type **SRV** so FiveM can find the correct port:
...
> [!TIP]
> If your server uses the default port `30120`, the A record alone is sufficient. The SRV record is only needed if your server uses a different port.
