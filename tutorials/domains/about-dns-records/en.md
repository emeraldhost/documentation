---
slug: "about-dns-records"
language: "en"
title: "DNS records"
description: "DNS stands for \"Domain Name System\" and is a system that is used to convert domain names such as \"www.example.com\" into IP addresses such as \"192.0.2.1\"."
tags: []
date: "2023-10-15"
visibility: "public"
updated: "2025-06-11"
...
short_title: "DNS-Records"
sort: 1
related: ["domains/nis2-domain-verification"]
---

## What are DNS records?

DNS stands for "Domain Name System" and is a system that is used to convert domain names such as `www.example.com` into IP addresses such as "192.0.2.1". DNS records are special information stored in a DNS server that enables this conversion. They contain various pieces of information that help a computer or other device connect to a specific server or website.

A DNS record usually consists of a name and a value. The name is the domain name to which the entry applies, such as `www.example.com`. The value is the corresponding IP address to which this domain name is to be resolved.
