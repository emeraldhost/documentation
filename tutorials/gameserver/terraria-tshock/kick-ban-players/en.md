...
language: "en"
title: "How to Kick and Ban Players on Your Terraria tShock Server"
...
> [!NOTE]
> In the server console you enter commands **without** a leading forward slash (`kick PlayerName`), in the in-game chat **with** one (`/kick PlayerName`). For the in-game commands you need an account with the matching permissions: [Add Admin](/tutorials/gameserver/terraria-tshock/add-admin).
