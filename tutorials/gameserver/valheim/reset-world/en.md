...
slug: "reset-world"
language: "en"
title: "How to Reset the World on Your Valheim Server"
...
> [!WARNING]
> Back up your current world before resetting it: create a [backup](/tutorials/gameserver/valheim/create-backup) via the dashboard or download the world to your PC ([Download Savegame](/tutorials/gameserver/valheim/download-savegame)).
...
2. **Connect via SFTP**\
   Connect to your server via [SFTP](/tutorials/gameserver/establish-sftp-connection) and go to the following directory:
...
3. **Rename or delete the world folder**\
...
4. **Download or delete old backups**\
...
> [!NOTE]
> You cannot set a specific seed via the dashboard, the server always picks a random one for a new world. If you want to play a world with a specific seed, create it locally in the game and then upload it to your server via [Add Savegame](/tutorials/gameserver/valheim/add-savegame).
