...
slug: "add-admin"
language: "en"
title: "How to Add an Admin to Your Left 4 Dead 2 Server"
description: "Add an admin to a Left 4 Dead 2 server"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
> **Requirement**
>
> Metamod:Source and SourceMod have to be installed on your server. See [Add Mods](/tutorials/gameserver/left-4-dead-2/add-mods) for how to do that.
...
1. **Join the server**\
   Connect to your server. See [Join Server](/tutorials/gameserver/left-4-dead-2/join-server) for how to do that.
...
> [!TIP]
> To learn how to remove players from your server as an admin, see [Kick & Ban Players](/tutorials/gameserver/left-4-dead-2/kick-ban-players).
