...
language: "de"
title: "So fügst Du einen Admin auf Deinem Counter-Strike Source Server hinzu"
description: "Admin auf einem Counter-Strike Source Server hinzufügen"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
sort: 1
related: ["gameserver/counter-strike-source/add-mods", "gameserver/counter-strike-source/create-backup", "gameserver/counter-strike-source/join-server", "gameserver/counter-strike-source/kick-ban-players"]
---

Counter-Strike Source bringt von Haus aus **kein Adminsystem** mit. Adminrechte im Spiel gibt es ausschließlich über **SourceMod**.

> [!WARNING]
> **Voraussetzung**
>
> Metamod:Source und SourceMod müssen auf Deinem Server installiert sein. Wie das geht, steht unter [Mods hinzufügen](/tutorials/gameserver/counter-strike-source/add-mods).
...
1. **Server beitreten**\
   Verbinde Dich mit Deinem Server. Wie das geht, steht unter [Server beitreten](/tutorials/gameserver/counter-strike-source/join-server).
...
> [!TIP]
> Wie Du Spieler als Admin vom Server entfernst, erfährst Du unter [Spieler kicken & bannen](/tutorials/gameserver/counter-strike-source/kick-ban-players).
