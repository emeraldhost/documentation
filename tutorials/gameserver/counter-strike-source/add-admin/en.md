...
slug: "add-admin"
language: "en"
title: "How to Add an Admin to Your Counter-Strike Source Server"
...
> **Requirement**
>
> Metamod:Source and SourceMod have to be installed on your server. See [Add Mods](/tutorials/gameserver/counter-strike-source/add-mods) for how to do that.
...
1. **Join the server**\
   Connect to your server. See [Join Server](/tutorials/gameserver/counter-strike-source/join-server) for how to do that.
...
> [!TIP]
> To learn how to remove players from your server as an admin, see [Kick & Ban Players](/tutorials/gameserver/counter-strike-source/kick-ban-players).
