...
slug: "add-admin"
language: "en"
title: "How to Add an Admin to Your Counter-Strike Global Offensive Server"
description: "Add an admin to a Counter-Strike Global Offensive server"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
Counter-Strike Global Offensive does **not** ship with an admin system. In-game admin rights are only available through **SourceMod**.

> [!WARNING]
> **Requirement**
>
> Metamod:Source and SourceMod have to be installed on your server. See [Add Mods](/tutorials/gameserver/counter-strike-global-offensive/add-mods) for how to do that.
...
1. **Join the server**\
   Connect to your server. See [Join Server](/tutorials/gameserver/counter-strike-global-offensive/join-server) for how to do that.
...
> [!TIP]
> To learn how to remove players from your server as an admin, see [Kick & Ban Players](/tutorials/gameserver/counter-strike-global-offensive/kick-ban-players).
