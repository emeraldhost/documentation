...
slug: "add-savegame"
language: "en"
title: "How to Add a Savegame to Your Nightingale Server"
...
> [!TIP]
> Create a [backup](/tutorials/gameserver/nightingale/create-backup) of your current server save before transferring anything, in case you want to switch back later.
...
3. **Join with the character you want**\
   Be the first to connect, using exactly the character whose progress you want to transfer. How to join your server is described in [Join Server](/tutorials/gameserver/nightingale/join-server).
...
Use this route for a save that already comes from a Nightingale server – for example from a [backup](/tutorials/gameserver/nightingale/create-backup) or from another server.
...
1. **Create a backup**\
   Create a [backup](/tutorials/gameserver/nightingale/create-backup) first. This step cannot be undone.
