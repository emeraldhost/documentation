...
slug: "add-admin"
language: "en"
title: "How to Add an Admin to Your Black Mesa Server"
description: "Add an admin to a Black Mesa server"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
> **Requirement**
>
> Metamod:Source and SourceMod have to be installed on your server. See [Add Mods](/tutorials/gameserver/black-mesa/add-mods) for how to do that.
...
1. **Join the server**\
   Connect to your server. See [Join Server](/tutorials/gameserver/black-mesa/join-server) for how to do that.
...
> [!TIP]
> To learn how to remove players from your server as an admin, see [Kick & Ban Players](/tutorials/gameserver/black-mesa/kick-ban-players).
