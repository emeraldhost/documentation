...
slug: "add-admin"
language: "en"
title: "How to Add an Admin to Your No More Room in Hell Server"
description: "Add an admin to a No More Room in Hell server"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
No More Room in Hell does **not** ship with an admin system. The official server documentation only covers the server console and RCON. In-game admin rights are only available through **SourceMod**.

> [!WARNING]
> **Requirement**
>
> Metamod:Source and SourceMod have to be installed on your server. See [Add Mods](/tutorials/gameserver/no-more-room-in-hell/add-mods) for how to do that.
...
1. **Join the server**\
   Connect to your server. See [Join Server](/tutorials/gameserver/no-more-room-in-hell/join-server) for how to do that.
...
> [!IMPORTANT]
> In No More Room in Hell RCON runs over TCP on the same port number as the game. The official documentation explicitly advises against exposing that TCP port to the internet – it can lead to security issues and denial of service attacks. When in doubt use the built-in console in the **dashboard**. Anyone who knows your RCON password has full control over your server.

> [!TIP]
> To learn how to remove players from your server as an admin, see [Kick & Ban Players](/tutorials/gameserver/no-more-room-in-hell/kick-ban-players).
