...
language: "de"
title: "So fügst Du einen Admin auf Deinem No More Room in Hell Server hinzu"
description: "Admin auf einem No More Room in Hell Server hinzufügen"
tags: []
date: "2026-07-30"
visibility: "public"
cta: "gameserver"
...
sort: 1
related: ["gameserver/no-more-room-in-hell/add-mods", "gameserver/no-more-room-in-hell/create-backup", "gameserver/no-more-room-in-hell/join-server", "gameserver/no-more-room-in-hell/kick-ban-players"]
---

No More Room in Hell bringt von Haus aus **kein Adminsystem** mit. Die offizielle Serverdokumentation kennt nur die Serverkonsole und RCON. Adminrechte im Spiel gibt es ausschließlich über **SourceMod**.

> [!WARNING]
> **Voraussetzung**
>
> Metamod:Source und SourceMod müssen auf Deinem Server installiert sein. Wie das geht, steht unter [Mods hinzufügen](/tutorials/gameserver/no-more-room-in-hell/add-mods).
...
1. **Server beitreten**\
   Verbinde Dich mit Deinem Server. Wie das geht, steht unter [Server beitreten](/tutorials/gameserver/no-more-room-in-hell/join-server).
...
```text
/nmrih/addons/sourcemod/configs/admins.cfg
```
...
> [!IMPORTANT]
> RCON läuft bei No More Room in Hell über TCP auf derselben Portnummer wie das Spiel. Die offizielle Dokumentation rät ausdrücklich davon ab, diesen TCP-Port ins Internet freizugeben – das kann zu Sicherheitsproblemen und Denial-of-Service-Angriffen führen. Nutze im Zweifel die eingebaute Konsole in der **Verwaltung**. Wer Dein RCON-Passwort kennt, hat die volle Kontrolle über Deinen Server.

> [!TIP]
> Wie Du Spieler als Admin vom Server entfernst, erfährst Du unter [Spieler kicken & bannen](/tutorials/gameserver/no-more-room-in-hell/kick-ban-players).
