...
language: "de"
title: "So änderst Du das Szenario auf Deinem Insurgency: Sandstorm Server"
...
sort: 21
related: ["gameserver/insurgency-sandstorm/change-map", "gameserver/insurgency-sandstorm/change-max-players", "gameserver/insurgency-sandstorm/change-server-name", "gameserver/insurgency-sandstorm/configure-kill-feed"]
---

Das Szenario legt den Spielmodus und die Fraktion für die gewählte [Map](/tutorials/gameserver/insurgency-sandstorm/change-map) fest (z.B. `Scenario_Ministry_Checkpoint_Insurgents`).
