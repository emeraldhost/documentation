...
language: "en"
title: "How to Change the Scenario on Your Insurgency: Sandstorm Server"
...
The scenario determines the game mode and faction for the selected [map](/tutorials/gameserver/insurgency-sandstorm/change-map) (e.g. `Scenario_Ministry_Checkpoint_Insurgents`).
