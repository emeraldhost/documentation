...
slug: "add-mods"
language: "en"
title: "How to Add Mods to Your Insurgency: Sandstorm Server"
...
- Persistent download problems: delete the mod.io cache (folder `mod.io/254/`) via [SFTP](/tutorials/gameserver/establish-sftp-connection) and re-authorize the server with a new code.
...
Some mods additionally require enabled **mutators**. To learn how to enable them, see the [Add Mutators](/tutorials/gameserver/insurgency-sandstorm/add-mutators) guide. Some mods also require entries in `Game.ini` – check the mod's description on mod.io for this.
