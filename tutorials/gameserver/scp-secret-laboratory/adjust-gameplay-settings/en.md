---
slug: "adjust-gameplay-settings"
language: "en"
title: "How to Adjust the Most Important Gameplay Settings on Your SCP: Secret Laboratory Server"
...
short_title: "Adjust Gameplay Settings"
sort: 1
related: ["gameserver/scp-secret-laboratory/assign-ranks", "gameserver/scp-secret-laboratory/configure-friendly-fire", "gameserver/scp-secret-laboratory/create-backup", "gameserver/scp-secret-laboratory/edit-config-files"]
---
...
The guide [Edit configuration files](/tutorials/gameserver/scp-secret-laboratory/edit-config-files) shows you where the configuration files are located, how to edit them and how to apply changes safely. All settings in this guide belong in the following file – replace `<Port>` with the game port of your server shown in the **Overview** of the dashboard:
...
Your server can show a message to all players when someone is kicked or banned. The guide [Kick and ban players](/tutorials/gameserver/scp-secret-laboratory/kick-and-ban-players) shows you how to kick and ban players.
...
- **Friendly fire** including the automatic teamkill punishments: [Configure friendly fire](/tutorials/gameserver/scp-secret-laboratory/configure-friendly-fire)
- **Whitelist**, so only listed players can join: [Set up a whitelist](/tutorials/gameserver/scp-secret-laboratory/set-up-whitelist)
