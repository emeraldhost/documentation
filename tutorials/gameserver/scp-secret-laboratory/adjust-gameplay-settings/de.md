---
slug: "gameplay-einstellungen-anpassen"
language: "de"
title: "So passt Du die wichtigsten Gameplay-Einstellungen auf Deinem SCP: Secret Laboratory Server an"
...
short_title: "Gameplay-Einstellungen anpassen"
sort: 5
...
Dein Server kann allen Spielern eine Nachricht anzeigen, wenn jemand gekickt oder gebannt wird. Wie Du Spieler kickst und bannst, zeigt Dir die Anleitung [Spieler kicken und bannen](/tutorials/gameserver/scp-secret-laboratory/kick-and-ban-players).
...
- **Friendly Fire** inklusive der automatischen Teamkill-Strafen: [Friendly Fire konfigurieren](/tutorials/gameserver/scp-secret-laboratory/configure-friendly-fire)
- **Whitelist**, damit nur eingetragene Spieler beitreten können: [Whitelist einrichten](/tutorials/gameserver/scp-secret-laboratory/set-up-whitelist)
