---
slug: "use-remote-admin"
language: "en"
title: "How to Use Remote Admin on Your SCP: Secret Laboratory Server"
...
1. **Join the server**\
   Connect to your server – see [Join Server](/tutorials/gameserver/scp-secret-laboratory/join-server).
...
Kicks and bans are also handled through Remote Admin – both via the panel and via commands. You can find all details in the guide [Kick & Ban Players](/tutorials/gameserver/scp-secret-laboratory/kick-and-ban-players).
