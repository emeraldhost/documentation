...
slug: "add-savegame"
language: "en"
title: "How to Add a Savegame to Your Abiotic Factor Server"
...
> [!TIP]
> Create a [backup](/tutorials/gameserver/abiotic-factor/create-backup) of your current server save before uploading, in case you want to switch back later.

> [!NOTE]
> **Why do the paths look like Windows paths?**
>
...
2. **Choose the right subfolder**\
   Open the folder whose name is a long sequence of numbers – that is your [SteamID64](/tutorials/gameserver/steamid64-find-out). Inside it, switch to the `Worlds` folder.
...
> [!CAUTION]
> **Console savegames cannot be transferred**
>
...
4. **Note the existing world folder**\
...
6. **Match the folder name**\
   ...
   > [!TIP]
   > **Alternative via the world name**
   >
