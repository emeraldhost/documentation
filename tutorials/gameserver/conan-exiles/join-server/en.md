...
slug: "join-server"
language: "en"
title: "How to Join Your Conan Exiles Server"
description: "Join a Conan Exiles server"
tags: []
date: "2026-04-09"
visibility: "public"
updated: "2026-07-30"
...
sort: 14
related: ["gameserver/conan-exiles/enable-battleye", "gameserver/conan-exiles/enable-pvp", "gameserver/conan-exiles/enable-vac", "gameserver/conan-exiles/kick-ban-players"]
---
...
5. **Start Conan Exiles**\
   Launch Conan Exiles.

6. **Search for server**\
   Select **Online** in the main menu and filter by **Favorites** – your server should now appear in the list.
...
1. **Start Conan Exiles**\
   Launch Conan Exiles and select **Online** in the main menu.
...
2. **Direct Connect**\
   Click on **Direct Connect** and enter the IP address and **Query Port** of your server.
